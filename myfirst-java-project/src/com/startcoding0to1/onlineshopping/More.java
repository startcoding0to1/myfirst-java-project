package com.startcoding0to1.onlineshopping;
...
public class More 
{
	...
	void meth3(int option)
	{
		...
		case 3:
			System.out.println();
			System.out.println(" 301  Hair oil----------->1------->RS.70");
			System.out.println(" 302  Shampoo------------>1------->RS.45");
			System.out.println(" 303  Face wash---------->1------->RS.90");
			System.out.println(" 304  Soap--------------->1------->RS.60");
			System.out.println("*****************************************************************************************");
			System.out.println(" Please choose your product code: ");
	...
	void Hair_oil(int option)
	{
		...
		if(s==1)
		{
			System.out.println(" Hair oil ===> How many do yo need?");
			int Q=ip.nextInt();
			double total=Q*70;
			obj.com_method(total,PN,PC,P,Q);
		}
	...
	void Shampoo(int option)
	{
		...
		if(s==1)
		{
			System.out.println(" Shampoo ===> How many do yo need?");
			int Q=ip.nextInt();
			double total=Q*45;
			obj.com_method(total,PN,PC,P,Q);
		}
	...
	void Face_wash(int option)
	{
		...
		if(s==1)
		{
			System.out.println(" Face_wash ===> How many do yo need?");
			int Q=ip.nextInt();
			double total=Q*90;
			obj.com_method(total,PN,PC,P,Q);
		}
	...
	void Soap(int option)
	{
		...
		if(s==1)
		{
			System.out.println(" Soap ===> How many do yo need?");
			int Q=ip.nextInt();
			double total=Q*60;
			obj.com_method(total,PN,PC,P,Q);
		}
	...
	void meth4(String name,String add,String phone)
	{
		...
		System.out.println(" Your final bill: "+(totalbill-discount));
